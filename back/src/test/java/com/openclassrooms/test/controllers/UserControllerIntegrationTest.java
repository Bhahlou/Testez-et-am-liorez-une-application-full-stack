...
class UserControllerIntegrationTest {
    ...
    @Test
    void findByIdShouldReturnUserDetail() throws Exception {
        mockMvc.perform(get("/api/user/" + existingUserId)
    ...
    void deleteShouldDeleteUser() throws Exception {
        mockMvc.perform(delete("/api/user/" + existingUserId)
                .header(HttpHeaders.AUTHORIZATION, "Bearer " + jwtToken))
                .andExpect(status().isOk());

        assertThat(userRepository.existsById(existingUserId)).isFalse();
    }

    @Test
    void findByIdShouldReturn404IfUserDoesNotExist() throws Exception {
    ...
    @Test
    void deleteShouldReturn404IfUserDoesNotExist() throws Exception {
